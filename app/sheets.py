...
from .models import MatchFixture, MatchOutcome, SnookerMatch, SnookerPlayer
...
class SnookerSheet:
    ...
    def get_matches(self, round: int = None, unplayed_only: bool = False) -> List[SnookerMatch]:
        if not round:
        ...
        for fixture in fixtures_data:
            if fixture["round"] == round:
                match = SnookerMatch(
                    date=try_parse_date(fixture.pop("date", None)),
                ...
                if unplayed_only and match.winner:
                    continue
    ...
    def update_match_by_id(self, id_: str, updates: dict):
    ...
    def record_match_outcome(self, id_: str, outcome: MatchOutcome):
        ...
        self.update_match_by_id(id_, updates)
